...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { department_id: @province.department_id, name: @province.name, ubigeo: @province.ubigeo } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { department_id: @province.department_id, name: @province.name, ubigeo: @province.ubigeo } }
